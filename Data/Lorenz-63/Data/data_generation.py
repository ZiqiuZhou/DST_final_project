...
train_data_raw = np.load(project_dir + 'lorenz_train.npy')
test_data_raw = np.load(project_dir + 'lorenz_test.npy')
...
np.save(project_dir + '/Data/Lorenz-63/Data/training_data_N100000.npy', data_dict_train)
...
data_dict_test['dt'] = 1
np.save(project_dir + '/Data/Lorenz-63/Data/testing_data_N100000.npy', data_dict_test)
