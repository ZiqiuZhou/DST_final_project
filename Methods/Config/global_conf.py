...
global_params.training_data_path = project_path + "/Data/{:s}/Data/training_data_N{:}.npy"
global_params.testing_data_path = project_path + "/Data/{:s}/Data/testing_data_N{:}.npy"
